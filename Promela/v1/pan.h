...
#define _nstates4	27	/* never_0 */
#define minseq4	70
#define maxseq4	95
#define _endstate4	26

#define _nstates3	7	/* :init: */
#define minseq3	64
#define maxseq3	69
#define _endstate3	6

#define _nstates2	17	/* tail */
#define minseq2	48
#define maxseq2	63
#define _endstate2	16

#define _nstates1	33	/* vehicle */
#define minseq1	16
#define maxseq1	47
#define _endstate1	32

#define _nstates0	17	/* leader */
#define minseq0	0
#define maxseq0	15
...
#define Air3	(sizeof(P3) - Offsetof(P3, v3tov2) - 1*sizeof(uchar))

#define Ptail	((P2 *)this)
typedef struct P2 { /* tail */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Air2	(sizeof(P2) - Offsetof(P2, vnum) - 1*sizeof(int))

#define Pvehicle	((P1 *)this)
typedef struct P1 { /* vehicle */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Air1	(sizeof(P1) - Offsetof(P1, tin1) - 1*sizeof(int))

#define Pleader	((P0 *)this)
typedef struct P0 { /* leader */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, vnum) - 1*sizeof(int))
